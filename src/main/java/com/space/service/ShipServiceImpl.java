...
public class ShipServiceImpl implements ShipService {
    ...
    public Ship createShip(Ship ship) {
        ...
        if (ship.getUsed() == null)     //--optional, default = false
            ship.setUsed(false);
    ...
    private void checkShipParams(Ship ship) {       //check всех ограничений полей
    ...
    public Specification<Ship> filterByDate(Long after, Long before) {
        return (root, query, cb) -> {
            ...
            return cb.between(root.get("prodDate"), dateAfter, dateBefore);
        };
    }
